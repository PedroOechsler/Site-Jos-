...
import {
  ArrowRight, ShieldCheck, Clock, Lock, BookOpen, BarChart2, Target,
  Lightbulb, PiggyBank, TrendingUp, CheckCircle, XCircle,
...
const faqs = [
  {
    ...
    answer: "Para qualquer pessoa que quer sair das dívidas, organizar suas finanças e construir um futuro mais tranquilo. Não importa quanto você ganha — o método funciona para qualquer renda.",
  },
  {
    question: "Preciso ter conhecimento prévio em finanças?",
    answer: "Não! O curso foi feito para quem está começando do zero. Tudo é explicado de forma simples e prática, sem jargões complicados.",
  },
  {
    question: "Em quanto tempo vou ver resultados?",
    answer: "Muitos alunos relatam mudanças já no primeiro mês. Com dedicação e aplicação do método, você começa a ver diferença no seu orçamento rapidamente.",
  },
  {
    question: "E se eu não gostar? Tem garantia?",
    answer: "Sim! Você tem 7 dias de garantia incondicional. Se por qualquer motivo não ficar satisfeito, basta nos enviar uma mensagem e devolvemos 100% do seu dinheiro — sem perguntas.",
  },
  {
    question: "Como funciona a consultoria inicial?",
    answer: "Após a compra, você agenda uma sessão de 30 minutos com o José Gonçalves para analisar sua situação financeira atual e criar um plano personalizado para você.",
  },
  {
    question: "Por quanto tempo tenho acesso?",
    answer: "Você tem acesso vitalício ao curso. Pode assistir quantas vezes quiser, no seu ritmo, de qualquer dispositivo.",
  },
];
...
function FAQItem({ question, answer }: { question: string; answer: string }) {
  ...
  return (
    ...
    >
      ...
      {open && (
        <div className="px-5 pb-4 text-sm" style={{ color: "#9ca3af" }}>{answer}</div>
      )}
    </div>
  );
}
...
export default function CursoPage() {
  ...
  return (
    <div style={{ backgroundColor: "#080808", color: "#ffffff", fontFamily: "'Inter', sans-serif", minHeight: "100vh" }}>
      ...
      {/* HERO */}
      <section style={{ backgroundColor: "#080808" }} className="py-12 px-4 text-center">
      ...
      <section style={{ backgroundColor: "#080808" }} className="py-16 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <h2 className="text-2xl md:text-3xl font-bold text-center mb-10">O que você vai aprender</h2>
      ...
      <section style={{ backgroundColor: "#080808" }} className="py-16 px-4">
        <div className="max-w-xl mx-auto">
          ...
          <h2 className="text-2xl md:text-3xl font-bold text-center mb-8">Tudo que você recebe hoje</h2>

          <div className="rounded-2xl overflow-hidden" style={{ border: "2px solid #22c55e" }}>
      ...
      <section style={{ backgroundColor: "#080808" }} className="py-16 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <h2 className="text-2xl md:text-3xl font-bold text-center mb-3">Vidas transformadas pelo método</h2>
